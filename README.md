...
### Data Collection
- Collected approximately 3000 - 3500 images in total
...
- Due to the 10-week time constraint, the use of public datasets was necessary to train the YOLOV8 model effectively
...
4. Export and optimize for Raspberry Pi deployment
