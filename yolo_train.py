...
def parse_arguments():
    ...
    parser.add_argument("--device", type=str, default="cpu", help="Device training index")
...
def main():
    ...
    if args.export_format:
        model.export(format=args.export_format, int8=args.int8_weights, imgsz=image_size, device=args.device, nms=True,
